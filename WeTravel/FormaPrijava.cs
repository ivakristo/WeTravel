    ...
    public partial class FormaPrijava : Form
    {
        ...
        private void buttonPrijava_Click(object sender, EventArgs e)
        {
            ...
            foreach (var zaposlenik in listaZaposlenik)
            {
                ...
                if (kriptiranaLozinka == zaposlenik.kriptirana_lozinka && textBoxKorisnickoIme.Text == zaposlenik.korisnicko_ime)
                {
            ...
            if (brojac == 1)
            {                
                MessageBox.Show("Uspješna prijava!","", MessageBoxButtons.OK,MessageBoxIcon.Information);
                this.Hide();
